...
urlpatterns = [
    ...
    path('catalogo/<int:catPk>/itemproducto/<int:itemPk>/remove',
         producto_catalogo_remove, name='producto_catalogo_remove'),
    path('catalogo/<int:catPk>/itemproducto/<int:itemPk>/add',
         producto_catalogo_add, name='producto_catalogo_add'),
    path('catalogo/<int:cat_pk>/items', items_get,
         name='items_get_by_catalogoId'),
    path('itemproducto/<int:itemPk>', productoCarrito_get,
         name='productoCarrito_get_by_itemId'),
...
<<<<<<< HEAD
    path('carrito/<int:user_pk>', shopping_cart_list_create, name='shopping_cart_list_create'),
...
=======
    path('carrito/<int:userPk>', shopping_cart_list_create,
         name='shopping_cart_list_create'),
    path('itemcarrito/<int:user_pk>', shopping_cart_item_list_create,
         name='shopping_cart_item_list_create'),
    path('itemcarrito/<int:user_pk>/itemcompra/<int:item_pk>', shopping_cart_item_update_delete,
         name='shopping_cart_item_update_delete'),
    path('users/', users_get, name='user_get'),
>>>>>>> GDD-125-1
]
