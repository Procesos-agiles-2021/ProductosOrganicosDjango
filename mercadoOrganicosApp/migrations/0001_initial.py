    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carrito',
                 models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='mercadoOrganicosApp.carrito')),
                ('item_compra',
                 models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='mercadoOrganicosApp.itemcompra')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='carrito',
            name='item_compras',
            field=models.ManyToManyField(through='mercadoOrganicosApp.ItemCompraCarrito',
                                         to='mercadoOrganicosApp.ItemCompra'),
        ),
        migrations.AddField(
            model_name='carrito',
            name='usuario_id',
